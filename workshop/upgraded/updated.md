...
### 5. 패키징 표준 최신화
- pyproject.toml 파일 추가로 최신 Python 패키징 표준(setuptools, wheel) 적용
- setup.py 없이 pip install . 및 빌드 가능
- 프로젝트 메타데이터, 의존성, 패키지 자동 탐색 등 표준화
...
이 문서는 upgraded 폴더의 현대화, 테스트 리팩터링, 패키징 표준 적용 과정을 기록합니다.
